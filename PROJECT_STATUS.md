...
| 2 | Structural Modeling & Conformational Ensembles | ◐ 2.1 WT Fv model + 2.2 Boltz-2 co-fold vs Aβ1-16 done (25 samples; iptm 0.961±0.019, P contacts both H&L); next 2.4 pose-cluster/epitope-register (gate, OQ-1), 2.3 MD ensemble (needs `lecam-md`) |
